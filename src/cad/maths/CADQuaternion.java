 ...
 */
public class CADQuaternion {

    private float w, x, y, z;

    public CADQuaternion(CADMatrix4f matrix4f) {
        super();
    ...
    private CADQuaternion(float w, float x, float y, float z) {
        super();
    ...
    public CADMatrix4f toRotationMatrix() {
        CADMatrix4f matrix = new CADMatrix4f();
    ...
    public static CADQuaternion interpolate(CADQuaternion quaternion2, CADQuaternion quaternion1, float blend) {
        CADQuaternion interpol = new CADQuaternion(1, 0, 0, 0);
